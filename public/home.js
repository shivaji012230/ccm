var app = angular.module("ccmApp", ['ngAnimate', 'ngAria', 'ngMaterial', 'ngMessages','ngCookies']);
...
app.factory('ccmFactory',['$http','$mdDialog','$timeout','$mdToast',function($http,$mdDialog,$timeout,$mdToast) {
...
app.controller("DialogController",['$scope','ccmFactory','$mdDialog','$http','$timeout',function($scope, ccmFactory, $mdDialog,$http,$timeout) {
...
//        var name1 = $("form[name='empfrm']").attr('name');
//        console.log(name1);
        $params = $.param({
    ...
    $scope.countryDialCode = function(event) { 
...
//    ccmFactory.getData(function(countryJson){    
//        return $scope.codes = countryJson;
//    });
